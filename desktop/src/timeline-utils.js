...
(function (root, factory) {
  ...
  function splitClipAtSourceTime(clip, sourceTime, nextId) {
    ...
    // Entry animation belongs to the original first frame; exit animation and
    // outgoing transition belong to its original final frame.
  ...
  return {
    ...
    previewToExportTime, exportToPreviewTime, layoutClips, locateSequentialTime,
    rulerStep, rulerTicks, timedRange, moveTimedRange, resizeTimedRange, packTimedItems, snapTime, splitTimedItem,
